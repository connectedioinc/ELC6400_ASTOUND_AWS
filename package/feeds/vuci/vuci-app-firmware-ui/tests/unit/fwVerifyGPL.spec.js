import FwVerifyGPL from '../../src/views/system/FwVerify.gpl.vue'
...
describe('fw verify tests', () => {
  it('invokes message when modem upgrade is rejectes', async () => {
    const wrapper = createWrapper(FwVerifyGPL)
  ...
  it('calls reconnect when modem is upgraded', async () => {
    const wrapper = createWrapper(FwVerifyGPL, { propsData: { keepSettings: true } })
  ...
  it.each([
    ...
    const wrapper = createWrapper(FwVerifyGPL, { propsData })
